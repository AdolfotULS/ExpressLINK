...
public class AuthController {
    ...
    public void registrarUsuario(Usuario usuarioRegistrar) throws SQLException {
        String query = "INSERT INTO usuario (nombre, email, password, telefono, rol) VALUES ('1', 'sucu_test', '123', '+56945678912', 'SUCURSAL')";
        // String query = "SELECT id, nombre, email, telefono, rol FROM usuario WHERE
        // email = ? AND password = ?";
